			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{asset('backend/img/itcs-logo-white.png')}}" alt="Guestbook Logo"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Electronic Buku Tamu Security</h1>
							<p>PT. Trimitra Chitrahasta</p>
						</div>
					</div>
